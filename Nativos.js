...
function myNInfinity() {
  document.getElementById("ninfinity").innerHTML = Number.NEGATIVE_INFINITY;
}

function myPInfinity() {
  document.getElementById("pinfinity").innerHTML = Number.POSITIVE_INFINITY;
}

function myE() {
  document.getElementById("e").innerHTML = Math.E;
}

function myLn10() {
  document.getElementById("ln10").innerHTML = Math.LN10;
}

function myLog1e() {
  document.getElementById("log1e").innerHTML = Math.LOG2E;
}

function myLog10e() {
  document.getElementById("log10e").innerHTML = Math.LOG10E;
}
...
function mySquart1_2() {
  document.getElementById("squart1_2").innerHTML = Math.SQRT1_2;
}

function mySquart2() {
  document.getElementById("squart2").innerHTML = Math.SQRT2;
}

function myTan() {
  document.getElementById("tan").innerHTML = Math.tan(90);
}

function myRaiz() {
  document.getElementById("raiz").innerHTML = Math.sqrt(9);
}

function myCos() {
  document.getElementById("cos").innerHTML = Math.cos(3);
}
...
function myRepeat() {
  var str = "Hello world!";
  document.getElementById("repeat").innerHTML = str.repeat(2);
}

function mytoString() {
  var str = "Hello World!";
  var res = str.toString();
  document.getElementById("tostring").innerHTML = res;
}

function mytoTime() {
  var d = new Date();
  var n = d.toTimeString();
  document.getElementById("totime").innerHTML = n;
}

function mytoLocale() {
  var d = new Date();
  var n = d.toLocaleString();
  document.getElementById("tolocale").innerHTML = n;
}